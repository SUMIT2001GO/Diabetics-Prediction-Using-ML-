...
df = pd.read_csv(r'C:\Users\SUMIT MITRA\Machine Learning Projects Final\Diabetics Prediction System\diabetes.csv')
...
def user_report():
    ...
    skin_thickness = st.sidebar.slider('SkinThickness', 0, 100, 20)
